{
  ...
  packages = [
    ...
    {
      name = "knip___knip_5.24.0.tgz";
      path = fetchurl {
        name = "knip___knip_5.24.0.tgz";
        url = "https://registry.yarnpkg.com/knip/-/knip-5.24.0.tgz";
        sha512 = "qbnpR4dPTcuUHR+koC6JKPdIEcjc4jvwNfGCJlfuKmo3WmOyaTFocdkOb4dcbCtxrAr81HW4ApuqMv5g4rzfiQ==";
      };
    }
    {
