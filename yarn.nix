{
  ...
  packages = [
    ...
    {
      name = "knip___knip_5.18.0.tgz";
      path = fetchurl {
        name = "knip___knip_5.18.0.tgz";
        url = "https://registry.yarnpkg.com/knip/-/knip-5.18.0.tgz";
        sha512 = "V+iJz2490zJQ11J0XCf7FggbiqY4L9HpmwSWS3BvwrH7W+bep9drx+Wj2dCU+8uSUijvwPB2unLbQKFCTuvT5g==";
      };
    }
    {
