{
  ...
  packages = [
    ...
    {
      name = "_types_node___node_20.12.9.tgz";
      path = fetchurl {
        name = "_types_node___node_20.12.9.tgz";
        url = "https://registry.yarnpkg.com/@types/node/-/node-20.12.9.tgz";
        sha512 = "o93r47yu04MHumPBCFg0bMPBMNgtMg3jzbhl7e68z50+BMHmRMGDJv13eBlUgOdc9i/uoJXGMGYLtJV4ReTXEg==";
      };
    }
    {
