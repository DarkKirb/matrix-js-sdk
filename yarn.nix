{
  ...
  packages = [
    ...
    {
      name = "_typescript_eslint_scope_manager___scope_manager_8.10.0.tgz";
      path = fetchurl {
        name = "_typescript_eslint_scope_manager___scope_manager_8.10.0.tgz";
        url = "https://registry.yarnpkg.com/@typescript-eslint/scope-manager/-/scope-manager-8.10.0.tgz";
        sha512 = "AgCaEjhfql9MDKjMUxWvH7HjLeBqMCBfIaBbzzIcBbQPZE7CPh1m6FF+L75NUMJFMLYhCywJXIDEMa3//1A0dw==";
      };
    }
    {
    ...
    {
      name = "_typescript_eslint_types___types_8.10.0.tgz";
      path = fetchurl {
        name = "_typescript_eslint_types___types_8.10.0.tgz";
        url = "https://registry.yarnpkg.com/@typescript-eslint/types/-/types-8.10.0.tgz";
        sha512 = "k/E48uzsfJCRRbGLapdZgrX52csmWJ2rcowwPvOZ8lwPUv3xW6CcFeJAXgx4uJm+Ge4+a4tFOkdYvSpxhRhg1w==";
      };
    }
    {
    ...
    {
      name = "_typescript_eslint_typescript_estree___typescript_estree_8.10.0.tgz";
      path = fetchurl {
        name = "_typescript_eslint_typescript_estree___typescript_estree_8.10.0.tgz";
        url = "https://registry.yarnpkg.com/@typescript-eslint/typescript-estree/-/typescript-estree-8.10.0.tgz";
        sha512 = "3OE0nlcOHaMvQ8Xu5gAfME3/tWVDpb/HxtpUZ1WeOAksZ/h/gwrBzCklaGzwZT97/lBbbxJ16dMA98JMEngW4w==";
      };
    }
    {
    ...
    {
      name = "_typescript_eslint_utils___utils_8.10.0.tgz";
      path = fetchurl {
        name = "_typescript_eslint_utils___utils_8.10.0.tgz";
        url = "https://registry.yarnpkg.com/@typescript-eslint/utils/-/utils-8.10.0.tgz";
        sha512 = "Oq4uZ7JFr9d1ZunE/QKy5egcDRXT/FrS2z/nlxzPua2VHFtmMvFNDvpq1m/hq0ra+T52aUezfcjGRIB7vNJF9w==";
      };
    }
    {
    ...
    {
      name = "_typescript_eslint_visitor_keys___visitor_keys_8.10.0.tgz";
      path = fetchurl {
        name = "_typescript_eslint_visitor_keys___visitor_keys_8.10.0.tgz";
        url = "https://registry.yarnpkg.com/@typescript-eslint/visitor-keys/-/visitor-keys-8.10.0.tgz";
        sha512 = "k8nekgqwr7FadWk548Lfph6V3r9OVqjzAIVskE7orMZR23cGJjAOVazsZSJW+ElyjfTM4wx/1g88Mi70DDtG9A==";
      };
    }
    {
