{
  ...
  packages = [
    ...
    {
      name = "typedoc___typedoc_0.25.12.tgz";
      path = fetchurl {
        name = "typedoc___typedoc_0.25.12.tgz";
        url = "https://registry.yarnpkg.com/typedoc/-/typedoc-0.25.12.tgz";
        sha512 = "F+qhkK2VoTweDXd1c42GS/By2DvI2uDF4/EpG424dTexSHdtCH52C6IcAvMA6jR3DzAWZjHpUOW+E02kyPNUNw==";
      };
    }
    {
